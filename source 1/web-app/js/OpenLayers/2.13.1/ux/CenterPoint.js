OpenLayers.Control.CenterPoint = OpenLayers.Class(OpenLayers.Control, {
    div: null,
    ...
    initDiv: function(){
        OpenLayers.Control.prototype.draw.apply(this, arguments);
        this.div = OpenLayers.Util.createDiv("divCenter");
    ...
    CLASS_NAME: "OpenLayers.Control.CenterPoint"
});