...
set AGENT_STRING=-javaagent:wrapper/springloaded-core-1.2.1.jar -noverify -Dspringloaded.synchronize=true -Djdk.reflect.allowGetCallerClass=true -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
